...
# Não inclua 'taxas' nas features, pois é a variável alvo!
...
print("\nRegressao Linear Treinando o modelo LogisticRegression para prever se é taxas ou não...")
...
plt.legend()
plt.title('Distribuição dos valores reais e preditos (taxas)')
plt.xlabel('taxas (0=Não, 1=Sim)')
plt.ylabel('Quantidade')
plt.show()

# 9. Comentários sobre o desempenho
if accuracy > 0.8:
    print("\n[COMENTÁRIO] O modelo apresentou boa acurácia! Isso indica que a Regressão Logística conseguiu aprender padrões relevantes para prever quem é taxas.")
else:
